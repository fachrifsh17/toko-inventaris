      ...
      <form action={formAction} className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-xs overflow-hidden">
            ...
            <div className="p-6 space-y-5">
              <div>
                ...
                <input id="nama_toko" name="nama_toko" type="text" defaultValue={pengaturan.nama_toko} placeholder="Masukkan nama toko" required className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-pink-500/20 focus:border-pink-500 transition-all duration-200" />
              </div>
              <div>
              ...
              <div>
                ...
                <textarea id="deskripsi" name="deskripsi" rows={4} defaultValue={pengaturan.deskripsi} placeholder="Tulis deskripsi profil singkat toko Anda" className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm resize-none focus:outline-none focus:ring-2 focus:ring-pink-500/20 focus:border-pink-500 transition-all duration-200" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-xs overflow-hidden">
            ...
            <div className="p-6 space-y-5">
              ...
              <div>
                ...
                <input id="email" name="email" type="email" defaultValue={pengaturan.email} placeholder="Masukkan email toko" className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-pink-500/20 focus:border-pink-500 transition-all duration-200" />
              </div>
              ...
              <div>
                ...
                <textarea id="embed_maps" name="embed_maps" rows={3} defaultValue={pengaturan.embed_maps} className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-xs font-mono resize-none focus:outline-none focus:ring-2 focus:ring-pink-500/20 focus:border-pink-500 transition-all duration-200" placeholder='<iframe src="https://www.google.com/maps/embed?..."></iframe>' />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-2xl border border-slate-100 shadow-xs p-6 text-center">
            ...
            <div className="relative border-2 border-dashed border-slate-200 hover:border-pink-500 rounded-2xl p-4 flex flex-col items-center transition-colors duration-200 group">
              ...
              />
              <span className="text-xs text-slate-400 group-hover:text-pink-600 transition-colors duration-200">Klik untuk ganti logo</span>
            </div>
            <div className="mt-6">
              <SubmitButton />
            </div>
...
function SubmitButton() {
  ...
  return (
    <button type="submit" disabled={pending} className="w-full px-6 py-3 bg-pink-600 hover:bg-pink-700 disabled:bg-slate-200 disabled:text-slate-400 text-white text-sm font-semibold rounded-xl transition duration-200 shadow-sm cursor-pointer disabled:cursor-not-allowed">
