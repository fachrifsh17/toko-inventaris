...
export default function RekapPage() {
  ...
  const openDetailModal = async (id: number) => {
    ...
    if (res) {
      setDetailData(res as unknown as TransaksiItem);
    }
        ...
        <div className="grid grid-cols-1 sm:grid-cols-5 gap-4">
          <div>
            ...
            <select
              ...
              className="w-full border border-slate-200 rounded-xl px-3 py-2 text-sm bg-slate-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition"
            >
              ...
              <>
                ...
                {detailData.keterangan && (
                  <div className="bg-slate-50 p-4 rounded-xl border border-slate-100">
                    ...
                    <p className="text-sm text-slate-600 italic">"{detailData.keterangan}"</p>
                  </div>
                )}
              </>
            ) : (
          ...
          <form onSubmit={handleEditSubmit} className="p-6 space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition resize-none"
              />
            </div>
